      ...
      <div className="w-full max-w-2xl space-y-6">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          <div className="px-6 pb-6">
            ...
            {profileMsg && (
              <div className={cx("flex items-center gap-2 text-sm px-4 py-3 rounded-xl mb-4 border",
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
          ...
          <div className="space-y-4">
            <Field label="Current Password">
              <PasswordInput value={passwords.currentPassword} onChange={v => setPasswords({ ...passwords, currentPassword: v })}
                visible={pwVisible.current} onToggle={() => setPwVisible({ ...pwVisible, current: !pwVisible.current })}
                placeholder="Your current password" />
            </Field>
            <div className="grid grid-cols-2 gap-4">
              <Field label="New Password">
                <PasswordInput value={passwords.newPassword} onChange={v => setPasswords({ ...passwords, newPassword: v })}
                  visible={pwVisible.next} onToggle={() => setPwVisible({ ...pwVisible, next: !pwVisible.next })}
                  placeholder="Min. 6 characters" />
              </Field>
              <Field label="Confirm Password">
                <PasswordInput value={passwords.confirmPassword} onChange={v => setPasswords({ ...passwords, confirmPassword: v })}
